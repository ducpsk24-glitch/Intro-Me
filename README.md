...
Run the one-line command matching your operating system. The installer downloads `introduction.c`, compiles it using GCC, and moves the resulting executable into your system's `PATH`.
